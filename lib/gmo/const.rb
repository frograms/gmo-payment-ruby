module Gmo
  module Const
    ...
    API_ERROR_MESSAGES_EN = {
      ...
      'E61030001' => 'It cannot be used with the current contract',
      'E61040001' => 'The current contract does not allow payment processing that specifies a card number',
    ...
    API_ERROR_MESSAGES_JA = {
      ...
      '42G440000' => 'セキュリティコードが誤っているため、決済を完了する事が出来ませんでした。',
